        ...
        if (user) {
          ...
          if (dbUser && active) {
            const data: UserProfileData = {
              ...
              address: dbUser.address || 'District Health HQ, Sector 4',
              city: dbUser.city || 'Gandhinagar',
              state: dbUser.state || 'Gujarat',
              pincode: dbUser.pincode || '382010',
              department: dbUser.department || 'Rural Health Administration',
              designation: dbUser.designation || 'Chief Medical Coordinator',
              assigned_area: dbUser.assigned_area || 'Rampur & Sitapur PHC Sectors',
            ...
            const demo: UserProfileData = {
              ...
              gender: 'Female',
              dob: '1992-05-14',
              address: 'District Health HQ, Sector 4',
              city: 'Gandhinagar',
              state: 'Gujarat',
              pincode: '382010',
              department: 'Rural Health Administration',
              designation: 'Chief Medical Coordinator',
              assigned_area: 'Rampur & Sitapur PHC Sectors',
